...
char ssid[] = "********";//ชื่อ WIFI
char pass[] = "********";//รหัส WIFI
String GAS_ID = "SKfycXxvP-oHHsZdX6ZCRY4GG4dHIfOZLR9PpL0V64o99BU2fPm8KJTOJkGh3q74xoOVB1hnZ"; //--> spreadsheet script ID
...
void loop()
{
  ...
  if ( val < 900 && !notificationSent ) // 1sec 
  {
    //
    LINE.notify("ตรวจพบเปลวไฟ");//คำที่จะส่งเข้าไลน์(สติกเกอร์ก็สามารถส่งได้)
    update_google_sheet();
